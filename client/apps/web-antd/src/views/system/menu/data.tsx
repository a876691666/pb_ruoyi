...
export const columns: VxeGridProps['columns'] = [
  ...
  },
  {
    ...
    slots: {
      default: ({ row }) => {
        const current = menuTypes[row.menu_type as 'C' | 'F' | 'M'];
        if (!current) {
          return '未知';
        }
        return (
...
export const drawerSchema: FormSchemaGetter = () => [
  ...
  },
  {
    ...
    dependencies: {
      // 类型不为按钮时显示
      show: (values) => values.menu_type !== 'F',
      triggerFields: ['menu_type'],
    },
  ...
  },
  {
    ...
    dependencies: {
      ...
      // 类型不为按钮时显示
      show: (values) => values?.menu_type !== 'F',
      triggerFields: ['isFrame', 'menu_type'],
    },
    fieldName: 'path',
  ...
  },
  {
    ...
    dependencies: {
      ...
      // 类型为菜单时显示
      show: (values) => values.menu_type === 'C',
      triggerFields: ['menu_type', 'path'],
    },
    fieldName: 'component',
  ...
  },
  {
    ...
    dependencies: {
      // 类型为菜单/按钮时显示
      show: (values) => values.menu_type !== 'M',
      triggerFields: ['menu_type'],
    },
    fieldName: 'perms',
