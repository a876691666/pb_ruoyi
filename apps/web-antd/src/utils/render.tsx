import type { Component as ComponentType, ShallowRef } from 'vue';
...
export function renderDictTag(
  value: number | string,
  dicts: DictData[] | ShallowRef<DictData[]>,
) {
  return (
    <DictTag
      dicts={Array.isArray(dicts) ? dicts : dicts?.value}
      value={value}
    ></DictTag>
  );
}
